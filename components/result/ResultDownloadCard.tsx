...
const ResultDownloadCard = forwardRef<HTMLDivElement, ResultDownloadCardProps>(
  ({ title, keywords, description, resultImageUrl }, ref) => {
    return (
      <div
        ref={ref}
        className="font-sans bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 w-[400px] h-[900px] rounded-3xl p-8 text-center space-y-6 shadow-2xl border-4 border-white relative overflow-hidden"
      >
