// /components/play/draw/Leaderboard.tsx
      ...
      <Card className="mt-4 bg-gradient-to-br from-white/90 via-purple-50/50 to-pink-50/50 dark:from-gray-800/90 dark:via-purple-900/40 dark:to-pink-900/40 backdrop-blur-sm shadow-xl border-0 h-fit lg:sticky lg:top-8">
        <CardContent className="p-4 sm:p-6">
          <header className="flex items-center gap-3 mb-4">
            ...
            <Badge className="bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 dark:from-purple-800/50 dark:to-pink-800/50 dark:text-purple-200 border-0 font-bold">
              <Users className="w-3 h-3 mr-1.5" />
              {rankings.length}
            </Badge>
          </header>

          <div className="space-y-2 max-h-[25rem] overflow-y-auto scrollbar-thin scrollbar-thumb-purple-200 dark:scrollbar-thumb-purple-700 scrollbar-track-transparent pr-1">
              ...
              <div
                ...
                className={`flex items-center gap-3 p-2.5 rounded-lg transition-all ${
                  player.rank <= 3
                    ...
                    : "bg-white/60 dark:bg-gray-800/50 hover:bg-white/90 dark:hover:bg-gray-700/70"
                }`}
              >
          ...
          {userScore !== null && userRank !== null && (
            <div className="mt-4 pt-4 border-t border-purple-200 dark:border-purple-800">
              <div className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-800/60 dark:to-pink-800/60 border-2 border-purple-200 dark:border-purple-600/70 shadow-lg">
                <div className="flex-shrink-0 w-6 text-center">
                  {getRankIcon(userRank)}
                </div>
                <div className="text-lg">🔻</div>
                <div className="flex-1 min-w-0">
                  <div className="font-bold text-purple-800 dark:text-purple-200 text-sm">
                    You
                  </div>
                </div>
                <div
