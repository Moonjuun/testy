...
export default function ResultPage({
  ...
  const { id } = use(params);
  const { result, clearResult, setResult } = useTestResultStore();
        ...
        <div className="max-w-4xl mx-auto grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800/50 rounded-2xl p-8 shadow-lg text-center transition-all duration-300 hover:shadow-xl hover:scale-[1.01]">
              <div className="mb-6">
                {result.result_image_url ? (
                  <Image
                    ...
                    width={192}
                    height={192}
                    className="w-48 h-48 mx-auto rounded-full object-cover border-4 border-white dark:border-gray-700 shadow-lg"
                    priority
                  />
                ) : (
              ...
              <p className="text-md md:text-lg text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto">
                {result.description}
              </p>
            </div>
