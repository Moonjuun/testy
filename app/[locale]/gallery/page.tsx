...
const galleryMetadata = {
  ko: {
    ...
    ogImage: "/og-gallery-ko.png", // 갤러리 전용 OG 이미지
  ...
  en: {
    ...
    ogImage: "/og-gallery-en.png", // Gallery-specific OG image
  ...
  ja: {
    ...
    ogImage: "/og-gallery-ja.png", // ギャラリー専用OG画像
  ...
  vi: {
    ...
    ogImage: "/og-gallery-vi.png", // Hình ảnh OG dành riêng cho thư viện
    ogImageAlt:
